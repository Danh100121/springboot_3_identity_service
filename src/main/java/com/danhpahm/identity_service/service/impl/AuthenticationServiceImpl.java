...
import com.danhpahm.identity_service.entity.InvalidatedToken;
...
import com.danhpahm.identity_service.repository.InvalidatedTokenRepository;
import com.danhpahm.identity_service.repository.UserRepository;
import com.danhpahm.identity_service.service.AuthenticationService;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private SignedJWT verifyToken(String token, boolean isRefresh) throws JOSEException, ParseException {
        JWSVerifier verifier = new MACVerifier((isRefresh ? REFRESH_SIGNER_KEY : SIGNER_KEY).getBytes());
...
//            throw new AppException(ErrorCode.UNAUTHENTICATED);
    ...
    private String generateToken(User user, boolean isRefresh) {
        ...
        try {
            jwsObject.sign(new MACSigner((isRefresh ? REFRESH_SIGNER_KEY : SIGNER_KEY).getBytes()));
